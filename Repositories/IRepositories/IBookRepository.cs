...
namespace NhaSachDaiThang_BE_API.Repositories.IRepositories
{
    public interface IBookRepository //: ICrudRepository<Book>, IGetActive<Book>, IGetByName<Book>, ISoftDelete
    {
        ...
        Task<int> CountByFillterAsync(int? categoryid = null, string? categoryName = null, decimal? minPrice = null, decimal? maxPrice = null, string? bookName = null, int? minQuality = null, int? maxQuanlity = null, bool? isPromotion = null, bool? isActive = null, int? languageId = null, int? bookCoverTypeId = null, bool? IsDel = null);
        ...
        Task<IEnumerable<Book>> GetByFilterAsync(int? categoryid = null,string?categoryName =null,decimal? minPrice=null, decimal? maxPrice=null, string? bookName = null,int?minQuality=null, int? maxQuanlity = null,bool? isPromotion = null, bool? isActive = null, int ?languageId=null,int? bookCoverTypeId=null, int? pageNumber = null, int? pageSize = null);
